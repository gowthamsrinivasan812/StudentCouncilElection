...
<div class="main-container">
    ...
    <div class="search-section">
        ...
        <div class="filter-row">
            ...
            <div class="filter-group">
                <label class="filter-label">Assembly Ward</label>
                <select class="filter-select" id="assemblyFilter">
                    <option value="">All Assembly Wards</option>
                    <option value="Anna Nagar">Anna Nagar</option>
                    <option value="Perambur">Perambur</option>
                    <option value="T Nagar">T Nagar</option>
                    <option value="Guindy">Guindy</option>
                    <option value="Avadi">Avadi</option>
                    <option value="Thiruvetriyur">Thiruvallur</option>
            ...
            <div class="filter-group">
                <label class="filter-label">Candidate Name</label>
                <input type="text" class="filter-input" id="candidateFilter" placeholder="Search by candidate name...">
            </div>
        </div>
    ...
    <div class="table-container">
        <div class="table-header">
            <h3 class="table-title">
                ...
                Approved Candidates
                <span class="candidates-count" id="candidatesCount">0 Candidates</span>
            </h3>
        </div>
        ...
        <div class="table-responsive">
            <table class="candidates-table">
                ...
                <tbody id="candidatesTableBody">
                    ...
                    while(rs.next()) {
                        candidateCount++;
                        byte[] blobpic = rs.getBytes(2);
                        byte[] blobsymbol = rs.getBytes(6);
                    %>
                    <tr data-district="<%= rs.getString(4) %>" data-assembly="<%= rs.getString(5) %>" data-candidate="<%= rs.getString(1) %>">
                        <td>
                            <%
                                if (blobpic != null) {
                        ...
                        <td>
                            ...
                            %>
                                    <img src="data:image/jpeg;base64,<%= base64Symbol %>" 
                                         class="symbol-image"
                                         alt="Party Symbol"
                                         title="Party Symbol">
                            <%
                    ...
                    <tr>
                        <td colspan="5" class="no-data">
                            ...
                            <p>There are currently no approved candidates in the system.</p>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
