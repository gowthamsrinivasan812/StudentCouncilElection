...
<div class="main-container">
    ...
    <div class="table-container">
        ...
        <div class="table-responsive">
            <table class="voters-table">
                ...
                <tbody id="votersTableBody">
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT * FROM `studentvoute`.`voteid` WHERE status='Accepted'");
            ...
            <img src="<%= blob %>" class="voter-image" />
        <% } else { %>
           <div class="no-image">
        ...
        <% } %>
                        ...
                        <td>
                            <a href="ved.jsp?email=<%=rs.getString(3)%>&dis=<%=t6%>&date=<%=dates%>" class="btn-allocate">
