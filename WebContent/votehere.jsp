            ...
            <div class="candidates-grid">
                ...
                PreparedStatement ps = con.prepareStatement(
                    ...
                    while(rs.next()) {
                        ...
                        Blob blobpic = rs.getBlob(5);
                        byte[] blobsymbol = rs.getBytes(6);
                        
                        
                        
                        if (blobpic != null) {
                        	imageBytes = blobpic.getBytes(1, (int) blobpic.length());
...
<% } %>
                    ...
                    <a href="voteed.jsp?cname=<%=rs.getString(2)%>&&cemail=<%=rs.getString(4)%>&&dept=<%=rs.getString(3)%>&&mail=<%=email%>" 
                       class="btn-vote">
