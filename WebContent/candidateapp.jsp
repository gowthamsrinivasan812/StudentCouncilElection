...
String dept=session.getAttribute("dept").toString();
    ...
    try {
        Connection con;
        con = dbconn.create();
        PreparedStatement ps = con.prepareStatement("SELECT student_id_photo FROM nominatecandidate WHERE email=?");
        ps.setString(1, email);
        ResultSet rs = ps.executeQuery();
        if (rs.next()) {
            byte[] blobImage = rs.getBytes("student_id_photo");
            if (blobImage != null) {
                base64Image = Base64.getEncoder().encodeToString(blobImage);
            }
        }
        rs.close();
        ps.close();
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <div class="candidate-image-container">
                            <% if (!base64Image.equals("")) { %>
                                <img src="data:image/jpeg;base64,<%= base64Image %>" 
                                     ...
                                     alt="Candidate Photo">
                                <p style="margin-top: 10px; color: #666; font-size: 0.9rem;">Candidate ID Photo</p>
                            <% } else { %>
                                <div class="no-image">
                        ...
                        <input type="hidden" name="pic" value="<%= base64Image %>">
                    </div>
