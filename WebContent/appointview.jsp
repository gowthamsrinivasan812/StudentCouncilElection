...
try {
    ...
    while (rs.next()) {
        candidateCount++;
       String blobsymbol = rs.getString(6);
       String blobime = rs.getString(5);
%>
<tr>
<td>
         <% if (blobime != null && !blobime.trim().isEmpty()) { %>
            <img src="<%= blobime %>" class="candidate-image" />
        <% } else { %>
            No Image
        <% } %>
    </td>
    ...
    <td>
         <% if (blobsymbol != null && !blobsymbol.trim().isEmpty()) { %>
            <img src="<%= blobsymbol %>" class="candidate-image" />
        <% } else { %>
            No Image
        <% } %>
    </td>
